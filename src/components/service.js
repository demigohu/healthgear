  ...
  return (
    <>
      <div className="flex flex-col px-5">
        <div className=" lg:w-1/2 mx-auto card card-base-100 border p-5 shadow-xl">
        ...
        <div className="border rounded-lg p-5 mt-10">
          <div className="flex flex-col item gap-2 text-white">
            <label>
              Select the patient whose medical record will be displayed:
            </label>
          ...
          <h2 className="mt-10 mb-5 font-semibold text-lg text-center text-white">
            Medical Records
          </h2>
